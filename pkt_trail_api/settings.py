"""
Django settings for pkt_trail_api project.
...
with open(os.path.join(CURRENT_DIR, ".env"), 'r') as f:
    for line in f:
        key, value = line.split("=", maxsplit=1)  # "=" in value ignored
...
INSTALLED_APPS = [
    ...
    'rest_framework',
    'corsheaders',
    'pkt_trail_api.apps.users',
    'pkt_trail_api.apps.resources',
]
...
ROOT_URLCONF = 'pkt_trail_api.urls'
